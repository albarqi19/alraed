...
export interface RegisterSchoolPayload {
  ...
  admin_email: string
  /**
   * رمزُ الإحالة — اختياريّ.
   *
   * الحقلُ يسأل «من دلَّك علينا» ولا يَعِد بشيء: ما وراءه شأنُ المنصّة لا
   * شأنُ من يسجّل، وإعلانُه على الشاشة يحوّل التسجيل إلى بحثٍ عن رمز.
   */
