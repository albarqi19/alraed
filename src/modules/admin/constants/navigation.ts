...
export const primaryAdminNavGroups: AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/admin/learning-difficulties', label: 'صعوبات التعلم', icon: Puzzle, permission: 'admin.learning_difficulties' },
...
export const settingsAdminNav: AdminNavGroup = {
  ...
  items: [
    ...
    { to: '/admin/app-notifications', label: 'إشعارات التطبيق', icon: Bell, permission: 'admin.fcm-test' },
