export function GuidanceProgramsPage() {
  return (
    <div className="space-y-6">
      <header>
        <h1 className="text-3xl font-bold text-slate-900">البرامج الإرشادية</h1>
        <p className="mt-2 text-sm text-slate-600">
          إدارة البرامج الإرشادية والتوعوية والندوات وورش العمل
        </p>
      </header>
        ...
        <div className="flex min-h-[400px] items-center justify-center">
          <div className="text-center">
            <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-teal-100">
              <i className="bi bi-lightbulb text-4xl text-teal-600"></i>
            </div>
