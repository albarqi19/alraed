 ...
 * `/admin/forms` وأبناؤها محوَّلون، لكن المطابقةَ تبقى دقيقةً لأنّ البادئة
 * تبتلع أيَّ ابنٍ جديدٍ يُضاف لاحقاً بلا تحويل، فيسقط داخل غلاف
 * `overflow:hidden` بلا ارتفاع ويُقصّ محتواه صامتاً.
 ...
 * `/admin/forms/123` (المصمّم) و`/admin/forms/123/submissions` (الردود) محوّلتان
 * معاً منذ 2026-08-18؛ وكانت الثانيةُ مستثناةً فتسقط في الحاوية العادية بحشوةٍ
 * وتمريرٍ خارجيّ — وهو الفراغُ الذي كان يظهر حول أطرافها الأربعة.
 */
const WORKSPACE_ROUTE_PATTERNS = [
  // المصمّم وصفحةُ الردود معاً — وكلتاهما محوّلة
  /^\/admin\/forms\/\d+(\/submissions)?$/,
