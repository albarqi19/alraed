...
export function InstallPWAPrompt() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center p-4 sm:items-center" role="dialog" aria-modal>
      ...
      <div className="relative w-full max-w-md overflow-hidden rounded-3xl bg-white dark:bg-slate-800 shadow-2xl">
        {/* Header with icon */}
        ...
        <div className="space-y-4 px-6 py-5">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-teal-50 dark:bg-teal-950">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">تذكير بالحصص</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">إشعارات فورية قبل بداية كل حصة</p>
              </div>
            </div>

            <div className="flex items-start gap-3">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-sky-50 dark:bg-sky-950">
                <svg className="h-4 w-4 text-sky-600 dark:text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <div className="flex-1">
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">أداء سريع</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">فتح فوري دون الحاجة للمتصفح</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">وصول سهل</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">أيقونة مباشرة على الشاشة الرئيسية</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">نماذج جاهزة</p>
                <p className="text-xs text-slate-500 dark:text-slate-400">الوصول للنماذج بسرعة ودون اتصال</p>
              </div>
            </div>
          </div>
        </div>
        ...
        {/* Actions */}
        <div className="flex items-center gap-2 border-t border-slate-100 dark:border-slate-700 bg-slate-50/50 dark:bg-slate-700/50 px-6 py-4">
          <button
            type="button"
            onClick={handleDismiss}
            className="text-xs font-medium text-slate-500 dark:text-slate-400 transition hover:text-slate-700 dark:hover:text-slate-300"
          >
            لا شكرًا
          </button>
          <div className="flex-1" />
          <button
            type="button"
            onClick={handleLater}
            className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-4 py-2 text-sm font-semibold text-slate-700 dark:text-slate-300 transition hover:border-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700"
          >
            لاحقًا
          </button>
          <button
