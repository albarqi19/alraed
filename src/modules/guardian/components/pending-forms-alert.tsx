...
export function PendingFormsAlert({ count, onViewForms }: PendingFormsAlertProps) {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      <div className="rounded-2xl border-2 border-amber-200 dark:border-amber-800 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950 dark:to-orange-950 p-5 shadow-lg">
