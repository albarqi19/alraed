...
function GuardianShellContent() {
    ...
    const { isDark } = useGuardianDarkMode()
    ...
    if (!isLoggedIn) {
        return (
            <div className={clsx(isDark && 'dark')}>
                <div className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-emerald-50 px-4 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
                    <div className="w-full max-w-md space-y-6 rounded-3xl bg-white p-8 shadow-xl dark:bg-slate-800 dark:shadow-slate-900/50">
                        <div className="text-center">
                            ...
                            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">بوابة ولي الأمر</h2>
                        ...
                        >
                            <div>
                                <label className="mb-2 block text-right text-sm font-semibold text-slate-700 dark:text-slate-300">
                                    رقم هوية الطالب
                                </label>
                                <input
                                    type="text"
                                    ...
                                    maxLength={10}
                                    className={clsx(
                                        'w-full rounded-2xl border px-4 py-3 text-center text-lg font-semibold tracking-widest shadow-sm transition focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:text-white dark:placeholder-slate-500',
                                        loginError ? 'border-rose-300 bg-rose-50 dark:border-rose-800 dark:bg-rose-950' : 'border-slate-200 bg-slate-50 dark:border-slate-600 dark:bg-slate-700'
                                    )}
                                    placeholder="••••••••••"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    maxLength={4}
                                    className={clsx(
                                        'w-full rounded-2xl border px-4 py-3 text-center text-xl font-semibold tracking-[0.5em] shadow-sm transition focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 dark:text-white dark:placeholder-slate-500',
                                        loginError ? 'border-rose-300 bg-rose-50 dark:border-rose-800 dark:bg-rose-950' : 'border-slate-200 bg-slate-50 dark:border-slate-600 dark:bg-slate-700'
                                    )}
                                    placeholder="••••"
                            ...
                            {loginError && (
                                <p className="text-center text-sm text-rose-600 dark:text-rose-400">{loginError}</p>
                            )}
                            <button
                                type="submit"
    ...
    return (
        <div className={clsx(isDark && 'dark')}>
            <div className="flex min-h-screen flex-col bg-slate-50 dark:bg-slate-900">
                {/* Top Header */}
                <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/90 shadow-sm backdrop-blur-md dark:border-slate-700/80 dark:bg-slate-800/90">
                    <div className="flex items-center justify-between px-4 py-3">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-right">
                                <p className="text-sm font-bold text-slate-900 line-clamp-1 dark:text-slate-100">{studentSummary?.name}</p>
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="relative flex h-10 w-10 items-center justify-center rounded-full bg-emerald-50 text-emerald-600 transition hover:bg-emerald-100 dark:bg-emerald-950 dark:text-emerald-400 dark:hover:bg-emerald-900"
                            ...
                            <div className="relative" ref={dropdownRef}>
                                ...
                                {showChildrenDropdown && (
                                    <div className="absolute left-0 top-full mt-2 w-64 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-xl dark:border-slate-700 dark:bg-slate-800">
                                        <div className="border-b border-slate-100 bg-slate-50 px-4 py-2 dark:border-slate-700 dark:bg-slate-700/50">
                                            <p className="text-xs font-semibold text-slate-600 dark:text-slate-300">الأبناء المسجلون</p>
                                        </div>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <div className="min-w-0 flex-1">
                                                            <p className={clsx(
                                                                'truncate text-sm',
                                                                index === activeChildIndex ? 'font-bold text-indigo-900 dark:text-indigo-300' : 'text-slate-700 dark:text-slate-300'
                                                            )}>
                                                                {child.name}
                                                            </p>
                                                    ...
                                                    {storedChildren.length > 1 && (
                                                        <button
                                                            ...
                                                            className="flex h-7 w-7 items-center justify-center rounded-full text-slate-400 transition hover:bg-rose-50 hover:text-rose-500 dark:text-slate-500 dark:hover:bg-rose-950 dark:hover:text-rose-400"
                                                            title="إزالة"
                                                        >
                                        ...
                                        <div className="border-t border-slate-100 p-2 dark:border-slate-700">
                                            <button
                                                ...
                                                className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-50 px-4 py-2.5 text-sm font-semibold text-indigo-600 transition hover:bg-indigo-100 dark:bg-indigo-950 dark:text-indigo-400 dark:hover:bg-indigo-900"
                                            >
                                        ...
                                        {storedChildren.length > 1 && (
                                            <div className="border-t border-slate-100 p-2 dark:border-slate-700">
                                                <button
                                                    ...
                                                    className="flex w-full items-center justify-center gap-2 rounded-xl px-4 py-2 text-sm font-medium text-rose-500 transition hover:bg-rose-50 dark:text-rose-400 dark:hover:bg-rose-950"
                                                >
                            ...
                            <button
                                ...
                                className="flex h-10 w-10 items-center justify-center rounded-full bg-rose-50 text-rose-500 transition hover:bg-rose-100 dark:bg-rose-950 dark:text-rose-400 dark:hover:bg-rose-900"
                ...
                {/* Bottom Navigation */}
                <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-slate-200/80 bg-white/95 pb-safe backdrop-blur-md dark:border-slate-700/80 dark:bg-slate-800/95">
                                ...
                                <NavLink
                                    ...
                                    className={clsx(
                                        ...
                                        isActive
                                            ...
                                            : 'text-slate-400 hover:bg-slate-50 hover:text-slate-600 dark:text-slate-500 dark:hover:bg-slate-700 dark:hover:text-slate-300'
                                    )}
                                >
                ...
                {showAddChildForm && (
                    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm dark:bg-black/60">
                        <div className="w-full max-w-md overflow-hidden rounded-3xl bg-white shadow-2xl dark:bg-slate-800">
                            {/* Header */}
                            <div className="flex items-center justify-between border-b border-slate-100 bg-gradient-to-r from-indigo-500 to-indigo-600 px-5 py-4 dark:border-slate-700">
                            ...
                            >
                                ...
                                <div className="flex gap-3 pt-2">
                                    <button
                                        type="button"
                                        onClick={() => setShowAddChildForm(false)}
                                        className="flex-1 rounded-2xl border border-slate-200 bg-slate-50 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-100 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-300 dark:hover:bg-slate-600"
                                        disabled={isLoggingIn}
                                    >
                                        إلغاء
                                    </button>
