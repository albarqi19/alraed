  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-slate-900">
      {isAppShellRoute ? null : (
        <header className="border-b border-white/40 bg-white/90 shadow-sm backdrop-blur">
      ...
      {isAppShellRoute ? null : (
        <footer className="border-t border-white/40 bg-white/80 py-6 text-center text-xs text-muted">
